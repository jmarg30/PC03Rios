...
import com.movileii.isil.pc03_rios.servicios.impl.UsuarioServiceImpl;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            servicio.setManager(getAssets());
            Usuario usuario = servicio.ingresar(dni, password);
            Toast.makeText(this,
                    "Ingreso "+usuario.getNombre(),
                    Toast.LENGTH_LONG).show();

            Intent objeto=new Intent(LoginActivity.this,MainActivity.class);
            Bundle obj=new Bundle();
            obj.putString("op","1");
            obj.putString("codigo","0");
